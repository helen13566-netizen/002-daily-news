...
**중학생도 한 번에 이해할 수 있게 써라.** 어려운 한자어·외래어·약자가 등장하면 즉시 괄호로 쉬운 말을 덧붙여라 (예: "거버넌스(운영 방식)", "IPO(주식 상장)"). 한 문장 80자 이내. 큰 숫자엔 친근한 비교 단위를 곁들여라 (예: "130억달러 = 한국 돈 약 18조원, 삼성전자 1년 영업이익 절반"). "→" 화살표 대신 서술형 문장. 능동태. 각 인사이트 문단 3~5문장 200~350자. "1차 효과는…, 2차 효과는…" 식으로 단계 명시. 구체 수치·회사명·연도 최소 2개 포함.

판단 기준: **읽었을 때 어머니나 동생이 한 번에 이해할 수 없으면 다시 써라.**
