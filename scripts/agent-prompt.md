...
print(f"[progress] pools: official={len(official_pool)}, ai={len(ai_pool)}, general={len(gen_pool)}")
PY
```
...
```json
{
  ...
  "articles": [
    {"article_id": "...", "title": "...", "source": "...",
     ...
     "content_text": "...", "category": "official_ai|ai_news|general_news",
     "keywords": [...],
     "ai_summary": "<140~220자>",
...
- **ai_news·general_news 카테고리가 3건 미달 시** `FAILED_STAGE=analyzing`
